...
<section class="resource-grid">
  ...
  <article id="resource-schemas" class="resource">
    <h3>XML Schemas</h3>
    <div class="wg">By <abbr title="XML Maintenance Group from Technical Committee 211 of International Organization for Standardization">ISO/TC 211 ISMG</abbr></div>
    ...
    <div class="source-links">
      <p>
      Source: <a href="https://github.com/ISO-TC211/XML">ISMG GitHub&nbsp;repository</a>
    </div>
  </article>
  ...
  <p>
    <small>
      Note: ISO/TC 211 Implementation Schema Maintenance Group (ISMG) used to be known as ISO/TC 211 XML Maintenance Group (XMG) before 2025.
    </small>
  </p>
